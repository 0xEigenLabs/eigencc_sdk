...
EIGENTEE_API eigen_t *
eigen_context_new(const eigen_enclave_info_t *enclave_info_ptr,
                  const char *user_id, const char *user_token,
                  sockaddr_t *tms_addr);

EIGENTEE_API eigen_t *
eigen_context_new2(const eigen_enclave_info_t *enclave_info_ptr,
                   const char *user_id, const char *user_token,
...
eigen_enclave_info_load(eigen_auditor_set_t *auditors_ptr,
                        const char *enclave_info_file_path_ptr);
EIGENTEE_API int
eigen_enclave_info_free(eigen_enclave_info_t *enclave_info_ptr);
...
// MesaTEE Task APIs
EIGENTEE_API eigen_task_t *eigen_create_task(eigen_t *ctx_ptr,
                                             const char *func_name_ptr);
EIGENTEE_API int eigen_task_free(eigen_task_t *eigen_task_ptr);
EIGENTEE_API int eigen_task_invoke_with_payload(eigen_task_t *eigen_task_ptr,
                                                const char *payload_buf_ptr,
                                                int payload_buf_len,
                                                char *result_buf_ptr,
                                                int result_buf_len);
