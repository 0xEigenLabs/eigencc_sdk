...
Napi::Value Init(const Napi::CallbackInfo &info) {
  ...
  if (!is_file_exist(pub)) {
    Napi::TypeError::New(env, std::string("Pub File do not exist: ") +
                                  std::string(pub))
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  ...
  if (!is_file_exist(pri)) {
    Napi::TypeError::New(env, std::string("Pri File do not exist: ") +
                                  std::string(pri))
        .ThrowAsJavaScriptException();
    return env.Null();
  }
  ...
  if (!is_file_exist(conf)) {
    Napi::TypeError::New(env, std::string("Conf File do not exist: ") +
                                  std::string(conf))
        .ThrowAsJavaScriptException();
    return env.Null();
  }
